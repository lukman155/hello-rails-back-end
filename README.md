...
> This is a back end project to use as a API endpoint for the "Hello world" project. You can find the front-end project here: [Hello Rails Front End](https://github.com/lukman155/hello-react-front-end).
...
- git clone https://github.com/lukman155/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/lukman155/hello-rails-back-end/issues).
